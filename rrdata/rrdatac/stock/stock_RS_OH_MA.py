...
from rrdata.utils import (rq_util_log_debug, rq_util_log_expection,rq_util_log_info)
from rrdata.utils import (rq_util_date_today, trade_date_sse,rq_util_get_trade_range,
                            rq_util_get_last_tradedate, rq_util_get_pre_trade_date)
from rrdata.utils import (PERIODS, is_trade_time_secs_cn)
from rrdata.utils import (client_pgsql, read_data_from_pg, read_sql_from_pg)
#from rrdata.rqFetch import (stock_code_to_name, fetch_delist_stock, fetch_realtime_price_stock_day_adj)
...
def stock_RT_HH_MA_last(table_name='stock_day_hfq', N=250):
