...
# RRSDK home dir
RRSDK_HOME = os.environ.get("RRSDK_HOME")
if not RRSDK_HOME:
    RRSDK_HOME = os.path.abspath(os.path.join(Path.home(), "rrsdk-home"))

# data for testing
RRSDK_TEST_HOME = os.path.abspath(os.path.join(Path.home(), "RRSDK-test-home"))
RRSDK_TEST_ZIP_DATA_PATH = os.path.join(RRSDK_TEST_HOME, "data.zip")
RRSDK_TEST_DATA_PATH = os.path.join(RRSDK_TEST_HOME, "data")
