...
from rrdata.utils import rq_util_get_last_tradedate
...
def fetch_get_stock_list_adj(trade_date=None, ts_code=False):  #TODO
    if not trade_date:
        trade_date = rq_util_get_last_tradedate().replace('-','')
...
def fetch_pro_bar(ts_code=None,asset="E", adj='qfq', start_date='20180101', end_date='20181011'): #TODO
